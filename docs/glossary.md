...
| Lease de outbox | Posse temporária e identificada de uma mensagem por uma instância do relay. | Expira para permitir recuperação; toda confirmação exige o mesmo lease ID. | Worker reivindica um lote até determinado Instant. | Flag permanente `processing` abandonada após uma queda. |
