...
| ActivityOccurrence | Aggregate Root de uma execução concreta, manual ou gerada, de uma Activity. | Preserva intenção civil, offset resolvido, instante UTC e revisão; é referenciada por planos e atribuições. | Culto de 09/08/2026 às 10h em America/Sao_Paulo. | Regra “todo domingo”. |
...
| AvailabilityRequest | Aggregate Root de uma coleta aberta por um time para um período civil e prazo UTC explícitos. | Pertence a Organization e MinistryTeam; orienta respostas antes de TeamSchedule e permite sobreposição. | Disponibilidade de agosto a outubro. | Período global obrigatório ou lista materializada de destinatários. |
