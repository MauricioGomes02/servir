...
| Infraestrutura local e migrations        | Implementação inicial     | Terraform administra quatro bridges segmentadas, volumes, PostgreSQL, Kafka, observabilidade e recursos independentes da API/relay sem construir imagens; Dockerfiles separados produzem artefatos promovíveis; Liquibase permanece job externo; registry/CI, readiness, RLS, identidades de runtime e IaC de ambientes compartilhados permanecem planejados                    |
...
| Aplicação web                            | Corte vertical inicial    | Workspace independente com web Vue e BFF Fastify; services separam componentes de gateways, somente o BFF conhece a API privada e serve o bundle estático; contexto de Organization na URL, temas claro/escuro/sistema, tokens semânticos, HTML semântico e layout mobile-first sustentam CreateOrganization e o workspace inicial                                              |
