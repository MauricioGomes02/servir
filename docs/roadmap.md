...
| Estratégia de testes                     | Migração em andamento     | Suítes unitária e PostgreSQL separadas; Organizations e Membership iniciam a remoção de adapters de persistência em memória; demais contextos seguem em cortes próprios                                                                                                                                                                                                         |
