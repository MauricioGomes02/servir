...
| Ministry e funções | Corte vertical inicial | Ministry é Aggregate Root separado; CreateMinistry, unicidade de nome ativo por organização, persistência/outbox atômicas, Integration Event v1 e entrada HTTP estão implementados; MinistryRole permanece planejada para DefineMinistryRole |
