...
| Estratégia de testes                     | Migração em andamento     | Suítes unitária e PostgreSQL separadas; handlers de Organizations, Membership, Ministries, Activities e Availability não dependem mais de adapters de persistência compartilhados em memória; composições HTTP seguem para o corte final                                                                                                                                           |
