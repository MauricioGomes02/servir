...
| Times ministeriais | Corte vertical inicial | CreateMinistryTeam implementado como root separada, com nome ativo único, isolamento por Organization, persistência/outbox atômicas, Integration Event v1 e entrada HTTP; TeamMembership, liderança vigente e responsabilidade por escala permanecem planejados |
