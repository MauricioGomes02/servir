...
| Infraestrutura local e migrations | Implementação inicial | Terraform administra rede, volumes protegidos, PostgreSQL, Kafka e, em state separado, o catálogo de tópicos; Compose limita-se ao Liquibase; aplicação real dos stacks, credenciais de runtime e IaC de ambientes compartilhados permanecem planejadas |
