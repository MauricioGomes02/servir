...
| Estratégia de testes                     | Migração em andamento     | Suítes unitária e PostgreSQL separadas; handlers de Organizations, Membership e Ministries não dependem mais dos adapters compartilhados em memória; demais composições e contextos seguem em cortes próprios                                                                                                                                                                    |
