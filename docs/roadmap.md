...
| Aplicação de relay durável | Implementação inicial | Comportamento de lote e storage PostgreSQL estão testados; Kafka, política concreta de retry, observabilidade, processo contínuo e encerramento seguro permanecem planejados |
