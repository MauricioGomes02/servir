...
export type MinistryRoleDefined = DomainEvent<
...
export function createMinistryRoleDefined(input: {
  ...
  return createDomainEvent({
    ...
    payload: {
      ...
      ministryRoleId: input.ministryRoleId.toString(),
      name: input.name.toString(),
    },
  });
}
export function isMinistryRoleDefined(event: DomainEvent): event is MinistryRoleDefined {
  return event.name === 'ministry.role_defined';
}
