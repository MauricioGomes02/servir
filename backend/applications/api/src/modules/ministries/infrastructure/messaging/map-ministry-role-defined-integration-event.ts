...
export function mapMinistryRoleDefinedIntegrationEvent(
  event: MinistryRoleDefined,
): MinistryRoleDefinedIntegrationEventV1 {
  return Object.freeze({
    channel: 'servir.ministries.events',
    source: 'urn:servir:ministries',
    type: 'servir.ministries.ministry.role-defined.v1',
