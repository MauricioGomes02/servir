...
export class InMemoryOrganizationRegistrationFactsReader implements OrganizationRegistrationFactsReader {
  ...
  constructor(source: ReadonlyArray<OrganizationId> | (() => ReadonlyArray<OrganizationId>)) {
  ...
  async findById(
    ...
    const found = this.organizationIds().find((candidate) => candidate.equals(organizationId));
