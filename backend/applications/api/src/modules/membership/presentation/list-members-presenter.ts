import type { ListMembersError, MemberPage } from '../application';
...
export class ListMembersPresenter {
  constructor(private readonly translator: MessageTranslator) {}
  present(
    result: Result<MemberPage, OrganizationIdError | ListMembersError | ValidationErrors>,
